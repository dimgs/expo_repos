...
def gallery(request, null=None):
    ...
    if result_var_dict == False:
       ...
       #SEARCH FIELD with text entry
           ...
           #Order Status "Date" - Descending
            if order_status_date == 1:
                paint_objects = Painting.objects.filter(Q(title__icontains=txt) | Q(description__icontains=txt) |
                                                        Q(f_artist__artist_name__icontains=txt) | Q(f_genre__genre_title__icontains=txt) |
                                                        Q(f_period__period_title__icontains=txt) | Q(f_museum__museum_title__icontains=txt) |
                                                        Q(f_artist__f_city__city_name__icontains=txt) | Q(f_museum__f_city__city_name__icontains=txt) |
                                                        Q(f_museum__museum_title__icontains=txt)).order_by('-published_date')
                order_status_date = 0
            #Order Status "Date" - Ascending
            elif order_status_date == 0:
                paint_objects = Painting.objects.filter(Q(title__icontains=txt) | Q(description__icontains=txt) |
            ...
            #Order Status "Popularity" - Descending
                ...
                paint_objects = Painting.objects.filter(Q(title__icontains=txt) | Q(description__icontains=txt) |
                                                        ...
                                                        Q(f_period__period_title__icontains=txt) | Q(f_museum__museum_title__icontains=txt) |
                                                        Q(f_artist__f_city__city_name__icontains=txt) | Q(f_museum__f_city__city_name__icontains=txt) |
                                                        Q(f_museum__museum_title__icontains=txt)).order_by('-counter_popularity')
                order_status_popularity = 0
            #Order Status "Popularity" - Ascending
            elif order_status_popularity == 0:
                paint_objects = Painting.objects.filter(Q(title__icontains=txt) | Q(description__icontains=txt) |
            ...
            #Order Status "Rating" - Descending
                ...
                paint_objects = Painting.objects.filter(Q(title__icontains=txt) | Q(description__icontains=txt) |
                                                        ...
                                                        Q(f_period__period_title__icontains=txt) | Q(f_museum__museum_title__icontains=txt) |
                                                        Q(f_artist__f_city__city_name__icontains=txt) | Q(f_museum__f_city__city_name__icontains=txt) |
                                                        Q(f_museum__museum_title__icontains=txt)).order_by('-rating')
                order_status_rating = 0
            #Order Status "Rating" - Ascending
            elif order_status_rating == 0:
                paint_objects = Painting.objects.filter(Q(title__icontains=txt) | Q(description__icontains=txt) |
